...
pub use layer::{
    ...
    GradientKind, GradientLayer, GradientLayerBuilder, Layer, LayerEntry, LayerId, RectLayer,
    SceneGraph, SemanticRole, ShadowLayer, SolidColor, TextAlignment, TextLayer,
};
